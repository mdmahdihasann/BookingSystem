    ...
    >
      ...
      <div className="flex flex-col justify-center w-full md:w-[500px] bg-white min-h-screen rounded-tl-[40px] rounded-bl-[40px] px-10 z-10">
        <div className="mb-8">
          ...
          <p className="text-sm font-serif font-normal text-gray-600">
            Let's hel you get strand
          </p>
        </div>
        <LoginFrom />
        ...
        <div>
          ...
          <p className="text-sm font-serif font-normal text-gray-600 text-end">
            Have a dont't account?{" "}
            <Link
